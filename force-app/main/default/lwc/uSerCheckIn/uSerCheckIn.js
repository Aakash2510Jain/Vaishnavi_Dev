...
import user_checkin from '@salesforce/apex/UserCheckInHelper.UserCheckin';
import user_checkout from '@salesforce/apex/UserCheckInHelper.UserCheckout';
import checkin_check from '@salesforce/apex/UserCheckInHelper.OnpageLoad';
import manage_breakTime from '@salesforce/apex/UserCheckInHelper.manageBreakTime';
import { refreshApex } from '@salesforce/apex';

import { ShowToastEvent } from 'lightning/platformShowToastEvent';
export default class USerCheckIn extends LightningElement {
    ...
    checkin() {
        ...
        user_checkin({ userId: uId }).then(result => {
            ...
            if (result == 'You can not checkin before 9:30 AM.') {
                this.showWarningToast('Checkin',result,'warning');
            }
        }).catch(err => {
