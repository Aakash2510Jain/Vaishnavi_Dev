...
import getRecordList from '@salesforce/apex/SimilarLeadsHelper.getLeads';
    ...
    wiredResponse(result){
        if(result.data){
            ...
            for(let i =0; i<result.data.length; i++){
                ...
                rec.url = 'https://vaishnavigroup--dev.sandbox.lightning.force.com/lightning/r/Lead__c/'+rec.Id+'/view';
